...
head_number = int(input("В какой вагон сел Витя? "))
inside_number = int(input("Какой номер вагона обнаружил Витя? "))

if head_number < 1 or inside_number < 1:
    print("Ошибка: Введите значение больше")
else:
    length = head_number - 1 + inside_number
    print(length)